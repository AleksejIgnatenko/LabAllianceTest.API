...
namespace LabAllianceTest.API.Helpers
{
    public class ClientsSeeder
    {
        ...
        public ClientsSeeder(IServiceProvider serviceProvider, LabAllianceTestAPIDbContext context)
        {
        ...
        public async Task AddOidcDebuggerClient()
        {
            ...
            var context = scope.ServiceProvider.GetRequiredService<LabAllianceTestAPIDbContext>();
        ...
        public async Task AddWebClient()
        {
            ...
            await manager.CreateAsync(new OpenIddictApplicationDescriptor
            {
                ...
                RedirectUris =
                {
                    new Uri("https://localhost:7243/swagger/oauth2-redirect.html")
                },
                PostLogoutRedirectUris =
                {
                    new Uri("https://localhost:7243/resources")
                },
                Permissions =
                {
                    Permissions.Endpoints.Authorization,
